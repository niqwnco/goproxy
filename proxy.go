...
func NewProxyHttpServer(d net.Dialer) *ProxyHttpServer {
	proxy := ProxyHttpServer{
		...
		Tr: &http.Transport{TLSClientConfig: tlsClientSkipVerify, Proxy: http.ProxyFromEnvironment, DialContext: d.DialContext},
	}
